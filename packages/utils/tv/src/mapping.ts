export function mapPropsVariants<T extends Record<string, any>, K extends keyof T>(props: T, variantKeys?: K[], removeVariantProps = true): readonly [Omit<T, K> | T, Pick<T, K> | {}] {
  if (!variantKeys) {
    return [props, {}]
  }
