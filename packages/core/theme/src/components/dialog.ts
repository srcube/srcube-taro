...
export const dialog = tv({
  slots: {
    wrapper: [],
    backdrop: [],
    content: ['absolute overflow-hidden m-auto w-full max-w-[90%] h-fit rounded-3xl bg-white shadow-sm'],
    header: ['p-3 text-center text-lg font-semibold'],
    body: ['px-4 pt-2 pb-4 text-zinc-500'],
    footer: ['p-0 h-12 border-t-2 border-t-solid border-t-zinc-200'],
    actionGroup: ['h-full'],
