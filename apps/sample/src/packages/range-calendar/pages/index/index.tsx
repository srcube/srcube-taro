import type { DateCalendarProps, DateRange, DateValue } from '@srcube-taro/ui'
        ...
        <Box className="space-y-3">
          ...
          {selectedRange && (
            <Box className="p-4 bg-gray-100 rounded-lg">
              <View className="text-sm text-gray-600">Selected Range: {selectedRange.start.toString()} ~ {selectedRange.end?.toString()}</View>
            </Box>
          )}
        </Box>
